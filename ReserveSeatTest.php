...
<form name="frm" action="https://balihaitours.com/CCInfo.php" target="_parent" method="get" onsubmit="return CheckForm(this);" style="font-size:medium; color:black; background-color:white">
