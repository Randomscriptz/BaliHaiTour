...
SV_WC_Framework_Bootstrap::instance()->register_plugin( '4.4.0', __( 'WooCommerce Twilio SMS Notifications', 'woocommerce-twilio-sms-notifications' ), __FILE__, 'init_woocommerce_twilio_sms_notifications', array(
...
class WC_Twilio_SMS extends SV_WC_Plugin {
	 ...
	 *
	 * @TODO Remove this as part of WC 2.7 compat {BR 2016-05-20}
	 *
	 * @since 1.8.0
	 */
	public function __get( $name ) {
		...
		switch ( $name ) {
			...
			case 'admin':
				...
				_deprecated_function( 'wc_twilio_sms()->admin', '1.8.0', 'wc_twilio_sms()->get_admin_instance()' );
				return $this->get_admin_instance();

			case 'ajax':

				/* @deprecated since 1.8.0 */
				_deprecated_function( 'wc_twilio_sms()->ajax', '1.8.0', 'wc_twilio_sms()->get_ajax_instance()' );
