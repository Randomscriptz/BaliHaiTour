					...
					foreach ( $rows as $row ) {
						...
						<tr>   
							...
							<?php if(WPDEVART_PRO === true ) : ?>
								<span class="buttons">
									<a  onclick="wpdevart_set_value('task','edit'); wpdevart_set_value('cur_id','<?php echo $row->id; ?>'); wpdevart_form_submit(event, 'reservations_form')"  class="action-button cal-edit-button wpdevart-button"><?php _e('Edit','booking-calendar'); ?></a>	
