=== WordPress booking calendar Pro ===
Contributors: wpdevart
Donate link: http://wpdevart.com/wordpress-booking-calendar-plugin
Tags: calendar, booking calendar, booking, booking plugin, calendar plugin, wordpress booking, reservation, reservation plugin
...
WordPress Booking Calendar plugin is an awesome tool to create a booking system for your website. Create booking calendars in a few minutes.
...
There is a lot of setting and useful functions that you can use for creating your booking calendar.

### View our WordPress Booking Calendar plugin Demo page: 
...
*   **Ability to set days availability(Available, Booked, Unavailable)**
*   **Ability to set day Price**
...
*   **Ability to change Week days format**
...
*   **Ability to add unlimited text fields in Form**
*   **Ability to add unlimited checkbox fields in Form**
*   **Ability to add unlimited TextArea fields in Form**
...
### The features of Booking Calendar Pro
...
*   **Reservation single and Month View**
...
Also, we recommend you to check our other plugins - [WordPress coming soon](https://wordpress.org/plugins/coming-soon-page), [WordPress Facebook like box](https://wordpress.org/plugins/like-box), [WordPress YouTube](https://wordpress.org/plugins/youtube-video-player), [WordPress Countdown plugin](https://wordpress.org/plugins/widget-countdown), [Facebook comments WordPress](https://wordpress.org/plugins/comments-from-facebook), [WordPress Poll plugin](https://wordpress.org/plugins/polls-widget/)  .
...
That's all, now you can creat Booking Calendars and insert it into your website.
...
You need to click twice on date.
...
After you selected the date you will see this options
...
*   Information for users - Type here information for your users(they will see it on calendar).
*   Information for administrators - Type here information for administrators. 
...
You can use the filters page to find reservations you need quickly and easier. Use the reservation Status, select the Period or use search field.
Also, use the Reservation Month View, we think it's s handy function.
