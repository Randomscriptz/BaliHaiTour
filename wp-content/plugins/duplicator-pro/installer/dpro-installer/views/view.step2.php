...
<form id='s2-input-form' method="post" class="content-form"  data-parsley-validate="true" data-parsley-excluded="input[type=hidden], [disabled], :hidden">
	...
	<div id="s2-cpnl-pane">
		<div class="hdr-sub1">
			<span id="s2-cpnl-status-icon"></span> cPanel Login: <a id="s2-cpnl-status-msg" href="javascript:void(0)" onclick="$('#s2-cpnl-status-details').toggle()"></a>
		</div>
	...
	<div id='s2-adv-opts' style="display:none">
		...
		<!-- GENERAL OPTS -->
		<div class="dupx-advopts-section">
			<div class="hdr-sub3">General</div>
			<table class="dupx-opts">
				<tr><td><input type="checkbox" name="zip_manual"  id="zip_manual" value="1" /> <label for="zip_manual" style="font-weight: normal">Manual package extraction</label></td></tr>
		...
		<!-- CONFIGURATION FILES -->
		<div class="dupx-advopts-section">
		<div class="hdr-sub3">Config Files</div>
			<table class="dupx-opts dupx-advopts">
				<tr>
					<td>Retention:</td>
...
<script type="text/javascript">
    ...
    DUPX.cpnlConnect = function ()
    {
        ...
        $('a#s2-cpnl-status-msg, span#s2-cpnl-status-icon').hide();
        ...
        var apiAccountActive = function(data)
        {
            ...
            if (CPNL_CONNECTED)
            {
                ...
                $('span#s2-cpnl-status-icon').html('<div class="circle-pass"></div>');
                $('a#s2-cpnl-status-msg').html('success');
            ...
            else
            {
                ...
                $('span#s2-cpnl-status-icon').html('<div class="circle-fail"></div>');
                $('a#s2-cpnl-status-msg').html('failed');
                $('div#s2-cpnl-status-details-msg').html(html);
                $('div#s2-cpnl-status-details').show(500);
                //Inputs
                DUPX.cpnlToggleLogin('off');
            }
            $('a#s2-cpnl-status-msg, span#s2-cpnl-status-icon').show(200);
    ...
    DUPX.cpnlToggleLogin = function (state)
    {
        ...
        if (state == 'on') {
            ...
            $('#s2-cpnl-connect-btn').attr('disabled', 'true');
            $('#s2-cpnl-change-btn').removeAttr('disabled').show();
        ...
        else
        {
            ...
            $('#s2-cpnl-connect-btn').removeAttr('disabled', 'true');
            $('#s2-cpnl-change-btn').attr('disabled', 'true');
