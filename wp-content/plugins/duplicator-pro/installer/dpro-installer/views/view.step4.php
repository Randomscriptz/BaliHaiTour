...
<form id='s4-input-form' method="post" class="content-form" style="line-height:20px">
	...
	<table class="s4-final-step">
		...
		<tr>
			<td class='step'><a class='s4-final-btns' href='<?php echo $_POST['url_new']; ?>' target='_blank'>Test Site</a></td>
			<td>
				<i>
		...
		<table class='s4-report-errs' style="width:100%; border-top:none">
			...
			<tr>
				<td data-bind="with: status.step1">
					<a href="javascript:void(0);" onclick="$('#s4-errs-create').toggle(400)">Step1: Deploy Results (<span data-bind="text: query_errs"></span>)</a><br/>
				</td>
				<td data-bind="with: status.step2">
					<a href="javascript:void(0);" onclick="$('#s4-errs-upd').toggle(400)">Step2: Update Results (<span data-bind="text: err_all"></span>)</a>
				</td>
				<td data-bind="with: status.step2">
