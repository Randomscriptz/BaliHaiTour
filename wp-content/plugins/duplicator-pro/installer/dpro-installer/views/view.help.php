...
STEP 1
============================================== -->
<h3>Step <span class="step">1</span> of 4: System Setup</h3>
<div id="dup-help-scanner" class="help-page">
    The "System Setup" screen shows the installers system requirements and notices.  All requirements must pass in order to proceed to Step 2.  Each requirement will show
...
STEP 2
============================================== -->
<h3>Step <span class="step">2</span> of 4: Deploy Files & Database</h3>
...
STEP 3
============================================== -->
<h3>Step <span class="step">3</span> of 4: Update Files & Database</h3>
