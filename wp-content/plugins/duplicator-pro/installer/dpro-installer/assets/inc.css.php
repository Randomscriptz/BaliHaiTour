<style>
	...
	COMMON VIEWS
     ============================ */
	div#content {border:1px solid #CDCDCD; width:750px; min-height:550px; margin:auto; margin-top:18px; border-radius:5px; box-shadow:0 8px 6px -6px #333; font-size:14px}
	...
	div.status-badge {float:right; border-radius:4px; color:#fff; padding:0 4px 0 4px;  font-size:12px; min-width:30px; text-align:center;}
	div.status-pass {background-color:#418446; }
	div.status-fail {background-color:maroon;}

    button.default-btn, input.default-btn {
		cursor:pointer; color:#fff; font-size:16px; border-radius:5px;	padding:6px 20px 4px 20px;
	...
	div.hdr-main {font-size:22px; padding:0 0 5px 0; border-bottom:1px solid #D3D3D3; font-weight:bold; margin:10px 0 30px 0;}
	...
	div.hdr-sub2 {font-size:16px; padding:2px 2px 2px 0; font-weight:bold; margin-bottom:5px; border:none}
	...
	div.s2-dbconn-result-data small{display:block; font-style:italic; color:#333; padding:3px 2px 5px 2px; border-bottom:1px dashed silver; margin-bottom:10px; text-align: center }
	...
	div.dupx-advopts-section {margin:15px 0 25px 0}
	div.dupx-advopts-help {margin:-5px 0 20px 0; text-align:center}
	table.dupx-advopts label.radio {width:50px; display:inline-block}

	/*Warning Area and Message */
	div.s2-warning-emptydb {color:#AF2222; margin:2px 0 0 0; font-size:11px; display: none}
	div.s2-warning-manualdb {color:#1B67FF; margin:2px 0 0 0; font-size:11px; display:none}
	div.s2-warning-renamedb {color:#1B67FF; margin:2px 0 0 0; font-size:11px; display:none}
	...
	table.s3-opts input {width:95% !important}
	...
	table.s4-final-step td {padding:5px 15px 5px 5px;font-size:14px; }
