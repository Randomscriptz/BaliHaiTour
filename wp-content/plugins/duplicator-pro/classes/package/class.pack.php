...
//        }
	...
	public function run_build()
	{
		...
		if ($this->build_progress->initialized == false) {
            ...
            if(($this->Type !== DUP_PRO_PackageType::MANUAL) && ($global->archive_build_mode === DUP_PRO_Archive_Build_Mode::DupArchive))
            {
                // Disallow schedules from using DAF for now - switch build back to zip
