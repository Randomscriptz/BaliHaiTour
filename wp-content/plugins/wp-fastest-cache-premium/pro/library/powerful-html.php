<?php
	class WpFastestCachePowerfulHtml{
		...
		public function lazy_load($content){
			...
			$content = WpFastestCacheLazyLoad::images_to_lazyload($content, $this->inline_scripts);
			$content = WpFastestCacheLazyLoad::iframe_to_lazyload($content, $this->inline_scripts);
