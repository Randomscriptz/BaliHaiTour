...
TdJsClientScript::addScript( 'initProductSwipebox', "jQuery('.woocommerce-main-image.swipebox,.product-thumbnails .swipebox').swipebox({useSVG: true, hideBarsDelay: 0, loopAtEnd: true});");
